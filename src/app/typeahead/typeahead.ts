...
export class NgbTypeahead implements ControlValueAccessor,
  ...
  @Output() itemSelected = new EventEmitter<NgbTypeaheadSelectItemEvent>();
  ...
  constructor(
    ...
    config: NgbTypeaheadConfig, ngZone: NgZone, @Inject(DOCUMENT) private _document: any,
  ...
  private _selectResult(result: any) {
    ...
    if (!defaultPrevented) {
      ...
      this.itemSelected.emit({ item: result, preventDefault: () => { defaultPrevented = true; } });
    }
  }
